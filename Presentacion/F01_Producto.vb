...
#Region "Metodos y funciones indispensables"
    ...
    Private Sub _Parametros()
        'PACK
        swPack.Visible = gs_Parametros(0).Item("syproductopack")
        LabelX14.Visible = gs_Parametros(0).Item("syproductopack")
        SuperTabItem_Pack.Visible = gs_Parametros(0).Item("syproductopack")
        'FAMILIA
        lbgrupo4.Visible = gs_Parametros(0).Item("syproductofamilia")
        cbgrupo4.Visible = gs_Parametros(0).Item("syproductofamilia")
    End Sub
