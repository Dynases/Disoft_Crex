...
#Region "Libreria"
    ...
    End Sub
    Public Shared Sub L_Modificar_Parametros(_Parametros As DataTable)
        Dim _Err As Boolean
        Dim Sql, _where, Valor As String
        If _Parametros(0).Item("sycompra").ToString = "True" Then
            Valor = 1
        Else
            Valor = 0
        End If
        Sql = _Parametros.Columns.Item(1).Caption + "=" + Valor.ToString
        For I = 2 To _Parametros.Columns.Count - 1
            If _Parametros(0).Item(I).ToString = "True" Then
                Valor = 1
            Else
                Valor = 0
            End If
            Sql = Sql + ", " + _Parametros.Columns.Item(I).Caption + "=" + Valor.ToString
        Next

        _where = "synumi = synumi"
        _Err = D_Modificar_Datos("Parametros", Sql, _where)
    End Sub
...
#Region "Farmacia Nota Entrega"
    Public Shared Function L_GetPersonas() As DataSet
        Dim _Tabla As DataTable
        Dim _Ds As New DataSet
        Dim _Where As String = " a.lazona =c.cenum " _
                                ...
                                + " and ccc.cecon = 4 "
        _Tabla = D_Datos_Tabla("a.*",
                               "TC002 a", " cbnumi = cbnumi")
        _Ds.Tables.Add(_Tabla)
        Return _Ds
    End Function
    Public Shared Function L_Recorrido(Optional _Cadena As String = "", Optional _Fecha As String = "") As DataTable
        Dim _Tabla As DataTable
        Dim _Where, _campos, _Order As String
        If _Cadena = "" Then
            _Where = "1=1"
        Else
            _Where = " ldchof = " + _Cadena + " And ldfec = '" + _Fecha + "'"
        End If
        _Order = " order by ldchof, ldfec desc, ldhora"
...
#Region "Sistema"
    Public Shared Function L_Parametros(Optional _Cadena As String = "") As DataTable
        ...
        _Tabla = D_Datos_Tabla(" * ", "parametros", "sycompra=sycompra")
        Return _Tabla
    End Function
#End Region
...
#Region "Usuarios"
    ...
    Public Shared Function L_Validar_Usuario2(_Nom As String, _Pass As String) As Boolean
        ...
        End If
    End Function
    Public Shared Function L_Validartabla(_Nom As String, _Codigo As String, ByRef NTabla As String) As Integer
        Dim _Tabla, _Tabla2 As DataTable
        Dim _where As String
        _Tabla = D_Datos_Tabla("*", "TB002", "bbtori = '" + _Nom + "'")
        If _Tabla.Rows.Count > 0 Then
            For Each reg As DataRow In _Tabla.Rows
                _where = _Tabla.Rows(0).Item("bbcdes") + " = " + _Codigo
                _Tabla2 = D_Datos_Tabla("*", _Tabla.Rows(0).Item("bbtdes"), _where)
                NTabla = _Tabla.Rows(0).Item("bbprog")
                If _Tabla2.Rows.Count > 0 Then
                    Return _Tabla2.Rows.Count
                End If
            Next
        Else
            Return 0
...
#Region "TO005 Caja"
    ...
    Public Shared Function L_prReporteObtenerCortes(numi As String) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prReporteObtenerDepositos(numi As String) As DataTable
        Dim _Tabla As DataTable
...
#Region "TV001 Ventas"
    ...
    End Sub
    Public Shared Function L_YaSeGraboTV001(_idpedido As Integer) As Boolean
        Dim _Tabla As DataTable
        Dim _resultado As Boolean
        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 28))
        _listParam.Add(New Datos.DParametro("@oanumi", _idpedido))
        _listParam.Add(New Datos.DParametro("@oluact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("sp_Mam_TO005", _listParam)
...
#End Region
    ...
    Public Shared Function L_fnReporteFacturadosV2(FechaI As String, FechaF As String) As DataTable
        Dim _Tabla As DataTable
    ...
    Public Shared Function L_fnReporteVentaAdminEstructura() As DataTable
        Dim _Tabla As DataTable

        Dim _listParam As New List(Of Datos.DParametro)
        _listParam.Add(New Datos.DParametro("@tipo", 7))
        _listParam.Add(New Datos.DParametro("@uact", L_Usuario))
        _Tabla = D_ProcedimientoConParam("MAM_ReporteVentaAdministrativo", _listParam)
        Return _Tabla
    End Function
    Public Shared Function L_fnReporteVentaGeneral(Proveedor As Integer, Categoria As Integer, Marca As Integer,
                                                   Atributo As Integer, Descripcion As String, FechaI As String, FechaF As String,
                                                   idcliente As Integer, idRepartidor As Integer, idProducto As Integer,
        ...
        _listParam.Add(New Datos.DParametro("@tipo", 1))
        _listParam.Add(New Datos.DParametro("@idProveedor", Proveedor))
        _listParam.Add(New Datos.DParametro("@cat", Categoria))
        _listParam.Add(New Datos.DParametro("@gr2", Marca))
        _listParam.Add(New Datos.DParametro("@gr3", Atributo))
        _listParam.Add(New Datos.DParametro("@desc2", Descripcion))
        ...
        _listParam.Add(New Datos.DParametro("@idProducto", idProducto))
        _listParam.Add(New Datos.DParametro("@idVendedor", idVendedor))
        _Tabla = D_ProcedimientoConParam("MAM_ReporteVentaAdministrativo", _listParam)

        Return _Tabla
    End Function
    Public Shared Function L_fnReporteVentaProveedor(Proveedor As Integer, Categoria As Integer, Marca As Integer, Atributo As Integer,
                                                     Descripcion As String, FechaI As String, FechaF As String,
                                                     idcliente As Integer, idRepartidor As Integer, idProducto As Integer,
                                                     idVendedor As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnReporteVentaCategoria(Proveedor As Integer, Categoria As Integer, Marca As Integer,
                                                     Atributo As Integer, Descripcion As String, FechaI As String,
                                                     FechaF As String, idcliente As Integer, idRepartidor As Integer,
                                                     idProducto As Integer, idVendedor As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnReporteVentaMarca(Proveedor As Integer, Categoria As Integer, Marca As Integer,
                                                 Atributo As Integer, Descripcion As String, FechaI As String,
                                                 FechaF As String, idcliente As Integer, idRepartidor As Integer,
                                                 idProducto As Integer, idVendedor As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnReporteVentaAtributo(Proveedor As Integer, Categoria As Integer, Marca As Integer,
                                                    Atributo As Integer, Descripcion As String, FechaI As String,
                                                    FechaF As String, idcliente As Integer, idRepartidor As Integer,
                                                    idProducto As Integer, idVendedor As Integer) As DataTable
        Dim _Tabla As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_fnReporteVentaProducto(Proveedor As Integer, Categoria As Integer, Marca As Integer,
                                                    Atributo As Integer, Descripcion As String, FechaI As String,
                                                    FechaF As String, idcliente As Integer, idRepartidor As Integer,
                                                    idProducto As Integer, idVendedor As Integer) As DataTable
        Dim _Tabla As DataTable
...
#Region "ESTADOS TABLA TO001D"
    ...
    Public Shared Function L_EstadoTO001D(_oanumi As Integer) As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_BuscarIdPedido(_idchofer As String, _fechaped As String, _conciliacion As String) As DataTable
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)

        _listPalam.Add(New Datos.DParametro("@tipo", 3))
        _listPalam.Add(New Datos.DParametro("@idchof", _idchofer))
        _listPalam.Add(New Datos.DParametro("@fechapedido", _fechaped))
